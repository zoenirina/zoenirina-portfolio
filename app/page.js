...
export default function Home() {
  return (
    <main className="antialiased bg-[#F5F5F5] dark:bg-[#09090b]">
      <div className="relative min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 grid-background">
        ...
        <div className="fixed w-screen h-screen bg-gradient-to-r from-[#F5F5F5]  to-[#F5F5F5]  dark:from-[#09090b]  via-transparent dark:to-[#09090b] opacity-800 z-40 top-0 left-0 right-0"> </div> 
        ...
        <div className="flex-1 z-99 relative"> 
          <Navbar />
          <Hero />
          <Service />
          <Skills />
