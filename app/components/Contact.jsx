...
export const Contact = () => {
  ...
  return (
<section id="contact" className="py-12 sm:py-20  relative min-h-[300px] sm:min-h-[400px] bg-[#e1d0f7] dark:bg-[#9473cb] border border-gray-300 dark:border-gray-950/40 overflow-hidden mx-6 xl:mx-24 my-6 rounded-lg">
  ...
  <div className="max-w-4xl mx-auto text-center relative z-10 px-4">
    <motion.h2
      className=" text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-slate-800 dark:text-white"
      initial="initial"
    ...
    <motion.p
      className="text-base sm:text-lg text-slate-700 dark:text-purple-50 max-w-2xl mx-auto mb-12"
      initial="initial"
      whileInView="whileInView"
